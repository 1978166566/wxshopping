...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "66a9107ca3e0460cb640a1bded9519a6";
    private static final String AUTH_TOKEN = "6832e992f4bb40a68661b93db375f04f";
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【歪秀购物】您的验证码为"+rod+"，请于"+1+"分钟内正确输入，如非本人操作，请忽略此短信。";
